...
inputs = {
  ...
  ssm_read_parameter_names = [
    ...
    "/slopmud/dev/google_oauth_client_id",
    "/slopmud/dev/google_oauth_client_secret",
    "/slopmud/dev/oidc_token_url",
    "/slopmud/dev/oidc_client_id",
    "/slopmud/dev/oidc_client_secret",
    "/slopmud/dev/oidc_scope",
    "/slopmud/stg/google_oauth_client_id",
    "/slopmud/stg/google_oauth_client_secret",
    "/slopmud/stg/oidc_token_url",
    "/slopmud/stg/oidc_client_id",
    "/slopmud/stg/oidc_client_secret",
    "/slopmud/stg/oidc_scope",
    "/slopmud/prd/google_oauth_client_id",
    "/slopmud/prd/google_oauth_client_secret",
    "/slopmud/prd/oidc_token_url",
    "/slopmud/prd/oidc_client_id",
    "/slopmud/prd/oidc_client_secret",
    "/slopmud/prd/oidc_scope",
    "/slopmud/dev/oidc_sso_auth_url",
    "/slopmud/dev/oidc_sso_token_url",
    "/slopmud/dev/oidc_sso_userinfo_url",
    "/slopmud/dev/oidc_sso_client_id",
    "/slopmud/dev/oidc_sso_client_secret",
    "/slopmud/dev/oidc_sso_redirect_uri",
    "/slopmud/dev/oidc_sso_scope",
    "/slopmud/stg/oidc_sso_auth_url",
    "/slopmud/stg/oidc_sso_token_url",
    "/slopmud/stg/oidc_sso_userinfo_url",
    "/slopmud/stg/oidc_sso_client_id",
    "/slopmud/stg/oidc_sso_client_secret",
    "/slopmud/stg/oidc_sso_redirect_uri",
    "/slopmud/stg/oidc_sso_scope",
    "/slopmud/prd/oidc_sso_auth_url",
    "/slopmud/prd/oidc_sso_token_url",
    "/slopmud/prd/oidc_sso_userinfo_url",
    "/slopmud/prd/oidc_sso_client_id",
    "/slopmud/prd/oidc_sso_client_secret",
    "/slopmud/prd/oidc_sso_redirect_uri",
    "/slopmud/prd/oidc_sso_scope",
  ...
  bootstrap_restore_track      = "prod"
  bootstrap_restore_env_prefix = "prd"
