...
EDGES: tuple[Edge, ...] = (
    ...
    Edge("dev_deploy", "dev_smoke", "dev deploy must be verified"),
    ...
    Edge("terraform_apply", "render_env", "new addresses flow from Terraform"),
...
WORKFLOWS: tuple[Workflow, ...] = (
    ...
    Workflow(
        ...
        "terraform_apply",
        "raft_smoke",
        ("render_env", "ensure_volumes", "deploy_split_units", "deploy_gateway", "raft_smoke"),
    ),
)
